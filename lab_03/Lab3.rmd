...
**The data are heavily skewed to the right (skewness of 3.03) and highly leptokurtic (kurtosis of 16.82). The large majority of flights arrive slightly early, however the data are heavily skewed by a fair number of flights which arrive very, very late (max of 7.4 hours). **
