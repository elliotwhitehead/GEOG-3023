...
hist(sample_means50$x_bar, breaks=50)
...
hist(sample_means_price50$mean_price, breaks=50)

print(mean(sample_means_price50$mean_price))


```
<b>The sample distribution is pretty normally distributed. I would guess the mean home price of the population to be pretty close to $180,000, as the mean of this sample distribution is $180,456.</b>
</div>
...
t-distribution with 59 degree of freedom? Use qt() to find the appropriate value
