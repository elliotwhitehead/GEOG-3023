...
t.test(nonsmoker$weight, smoker$weight)
print(mean(smoker$weight))
print(mean(nonsmoker$weight))

```
**The conclusion of the two-sample test is that we can reject the null hypothesis, AKA, the mean brithweight is not the same between smoking and non-smoking mothers**
</div>
