...
# A. Probability dice 1 is less than 4
dice_df %>%
  summarise(d1_lt_4 = sum(new_dice1 < 4) / n())

# B. Probability dice 1 and dice 2 rolls a 6
dice_df %>%
  summarise(both_roll_six = sum(new_dice1 == 6 & new_dice2 == 6) / n())

# C. Probability (dice 1 is 1 or 2) and (dice 2 is a 5)
dice_df %>%
  summarise(d1_is_1or2_and_d2_is_5 = sum((new_dice1 == 1 | new_dice1 == 2) & new_dice2 == 5) / n())
