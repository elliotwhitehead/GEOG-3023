...
We will do this a couple steps, first creating our own data.frame with only the 
numbers we want to analyse. Similar with the previous case, we can select the
